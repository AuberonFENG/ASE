...
//#endif
namespace Agora_RTC_Plugin.JoinChannelVideo
{
    public class JoinChannelVideo : MonoBehaviour
    {
        ...
        public Dictionary<uint, VideoSurface> remoteViews = new Dictionary<uint, VideoSurface>();
    ...
    private ArrayList permissionList = new ArrayList() { Permission.Camera, Permission.Microphone };
        ...
        internal class UserEventHandler : IRtcEngineEventHandler
        {
            ...
            {
                Debug.Log(string.Format("OnJoinChannelSuccess in Video channelName: {0}, uid: {1}, elapsed: {2}",
